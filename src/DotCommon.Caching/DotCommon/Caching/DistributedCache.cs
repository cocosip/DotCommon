...
namespace DotCommon.Caching
{
    ...
    {
        public const string UowCacheName = "DotCommonDistributedCache";
        ...
        private readonly DotCommonDistributedCacheOptions _distributedCacheOption;

        public DistributedCache(
            IOptions<DotCommonDistributedCacheOptions> distributedCacheOption,
        ...
        protected virtual KeyValuePair<TCacheKey, TCacheItem?>[] ToCacheItems(byte[]?[] itemBytes, TCacheKey[] itemKeys)
        {
            ...
            {
                throw new DotCommonException("count of the item bytes should be same with the count of the given keys");
            }
