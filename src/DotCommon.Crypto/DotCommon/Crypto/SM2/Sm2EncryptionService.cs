...
namespace DotCommon.Crypto.SM2
{
    public class Sm2EncryptionService : ISm2EncryptionService
    {
        protected DotCommonSm2EncryptionOptions Options { get; }

        public Sm2EncryptionService(IOptions<DotCommonSm2EncryptionOptions> options)
        {
