...
{
    public class Sm4EncryptionService : ISm4EncryptionService
    {
        protected DotCommonSm4EncryptionOptions Options { get; }
        public Sm4EncryptionService(IOptions<DotCommonSm4EncryptionOptions> options)
        {
