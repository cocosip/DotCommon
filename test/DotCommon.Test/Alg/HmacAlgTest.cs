...
namespace DotCommon.Test.Alg
{
    public class HmacAlgTest
    {
        ...
        public void HmacSha1_GetStringHmacSha1_Test()
        {
            ...
            var hmacSha1Value = HmacAlg.GetStringHmacSha1(source, "12345678");
        ...
        {
            var source = "zero1000";
            var hmacSha256Value = HmacAlg.GetStringHmacSha256(source, "111111");
        ...
        {
            var source = "zero1000";
            var hmacMd5Value = HmacAlg.GetStringHmacMd5(source, "111111");
