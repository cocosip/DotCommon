...
namespace DotCommon.Test.Encrypt
{
    public class Netstandard2RSAHelperTest
    {
        ...
        public void Encrypt_Decrypt_Test()
        {
            ...
            var str = "HelloWorld!";
            var encrypted1 = Netstandard2RSAHelper.EncryptAsBase64(str, publicKey1, RSAEncryptionPadding.Pkcs1);
            var decrypted1 = Netstandard2RSAHelper.DecryptFromBase64(encrypted1, privateKey1, RSAEncryptionPadding.Pkcs1);
