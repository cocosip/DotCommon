...
namespace DotCommon.Test.Dependency
{
    public class AbpContainerTest
    {
        ...
        public void AbpContainer_Test()
        {
            ...
            var container = DotCommon.Dependency.IocManager.GetContainer();
            container.Register<InterfaceContainerTest, ContainerTestImpl1>(DotCommon.Dependency.DependencyLifeStyle.Transient, "impl1");
            container.Register<InterfaceContainerTest, ContainerTestImpl2>(DotCommon.Dependency.DependencyLifeStyle.Transient, "impl2");
